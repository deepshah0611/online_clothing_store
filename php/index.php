...
<A name="top"></A>
    ...
    <!-- MENUS -->
        ...
        <nav class="topnav" id="myTopnav">
          <img class="attirent" src="../images/logo.png" width=150 height=75>
              ...
              <ul>
                <li><a href="../templates/weddingmen.html">MEN   <i class="fas fa-male" style="font-size:15px"></i></a>
                  <ul>
                    ...
                    <li><a href="../templates/weddingmen.html">WEDDING </a></li>
                ...
                <li><a href="../templates/weddingwomen.html">WOMEN   <i class="fas fa-female" style="font-size:15px"></i></a>
                  <ul>
                    ...
                    <li><a href="../templates/weddingwomen.html">WEDDING  </a></li>
...
<div class="coltextone" style="margin-top: 80px;margin-left: 400px; color: #020480;text-shadow: 2px 2px red;">
  ...
  <div class="flip-card-inner">
    <div class="flip-card-front">
      <img src="../images/whitetexture.jpg" alt="Avatar" style="border-radius: 50%; width:200px;height:350px;">
    </div>
...
<div class="flip-card" align="center">
  <div class="flip-card-inner">
    <div class="flip-card-front">
      <img src="../images/velvetbridalsmart.jpg" alt="Avatar" style="border-radius: 50%;width:200px;height:350px;">
    </div>
    <div class="flip-card-back">
