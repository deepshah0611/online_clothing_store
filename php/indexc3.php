...
session_start();
$con = mysqli_connect("localhost","root","","id11147977_register");
...
<body background="../images/cartbackground.jpg">
...
?>
<div class="cart_div">
<a href="cartc3.php"><img src="../images/cart-icon.png" /> Cart<span><?php echo $cart_count; ?></span></a>
</div>
<?php
}
...
while($row = mysqli_fetch_assoc($result)){
		echo "<div class='product_wrapper'>
			  ...
			  <div class='image'><img src='../images/".$row['image']."' height='350' width='250' /></div>
